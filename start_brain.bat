...
echo [AI Companion Brain] Default LLM is Ollama llama3 at http://localhost:11434/v1
echo [AI Companion Brain] Set AI_COMPANION_LLM_* environment variables to use another provider.
